...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Valtor — Bid Intelligence & Infrastructure Risk" },
      { name: "description", content: "The industrial standard for neural BoQ analysis and infrastructure tender evaluation." },
      { property: "og:title", content: "Valtor — Bid Intelligence & Infrastructure Risk" },
      { property: "og:description", content: "Quantifying construction bid risk for industrial procurement." },
    ],
  }),
  component: Index,
});
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 px-6 py-20 md:flex-row md:items-center">
          <div>
            ...
            <h3 className="mt-4 max-w-2xl text-3xl font-black uppercase tracking-tighter text-slate-900 md:text-4xl">
              Deploy Valtor against your active tender book.
            </h3>
          </div>
          <Link
            to="/auth"
      ...
      <footer className="bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-6 py-10 md:grid-cols-3">
          <div className="flex items-center gap-3">
            ...
            <span className="label-xs text-slate-900">Valtor Systems</span>
          </div>
